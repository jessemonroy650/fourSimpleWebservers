...
var restapis     = require(myServerJS + '/rest-api');
var asyncMonitor = restapis.restapis;
var rtNavigate   = restapis.rtNavigate;
var asyncSystem  = restapis.asyncSystem;
//
...
//
var theIndex      = {'/':true };
var theRESTs      = {'/monitor':true, '/navigate':true , '/system':true};
var theRESTsAPI   = {'/monitor':asyncMonitor, '/navigate':rtNavigate , '/system':asyncSystem};
...
http.createServer(function (request, response) {
    ...
    isREST   = theRESTs[theURL.pathname];
